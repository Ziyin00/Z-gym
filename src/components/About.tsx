...
const featured = [
  {
    ...
    subtitle:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum eveniet unde blanditiis recusandae ipsa impedit quisquam ex ullam culpa nisi quo adipisci, ",
  },
  {
    icon: <IoIosPricetags />,
    title: "execellent trainers",
    subtitle:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum eveniet unde blanditiis recusandae ipsa impedit quisquam ex ullam culpa nisi quo adipisci, ",
  },
  {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-2 mb-8 ">
          ...
          >
            ...
            Suscipit expedita similique cumque tempore!
          </motion.p>
        </div>
